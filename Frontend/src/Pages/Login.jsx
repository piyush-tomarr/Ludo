...
import { loginFun, googleAuthFun } from "../Services/ApiFun";
...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await loginFun(formData.email, formData.password);
    ...
    return (
        <div className={classes.container}>
            ...
            <div className={classes.authCard}>
                <h1 className={classes.title}>{t("WELCOME BACK")}</h1>
                <p className={classes.subtitle}>
                    {t("Log in with your email to continue playing Ethio Ludo!")}
                </p>
                ...
                <p className={classes.switchModeText}>
                    ...
                    <button type="button" className={classes.switchModeButton} onClick={() => navigate("/signup")}>
                        {t("Sign up")}
                    </button>
                </p>
